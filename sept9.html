...
<html lang="en">
  ...
  <body>
    <div class="reveal">
      <div class="slides"><section  data-markdown><script type="text/template"><!-- .slide: class="drop" data-background-opacity="0.5" data-background-image="mt-everest.jpg" -->
...
<img src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/a8/Andrei_Markov.jpg/440px-Andrei_Markov.jpg" alt="" style="object-fit: scale-down">
...
<img src="a-to-b.png" alt="" style="object-fit: scale-down">
...
<img src="match1.png" alt="" style="object-fit: scale-down">
</div></script></section><section  data-markdown><script type="text/template"><!-- .slide: class="drop" -->
<div class="" style="position: absolute; left: 0px; top: 0px; height: 700px; width: 960px; min-height: 700px; display: flex; flex-direction: column; align-items: center; justify-content: center" absolute="true">

<img src="match2.png" alt="" style="object-fit: scale-down">
</div></script></section><section  data-markdown><script type="text/template"><!-- .slide: class="drop" -->
<div class="" style="position: absolute; left: 0px; top: 0px; height: 700px; width: 960px; min-height: 700px; display: flex; flex-direction: column; align-items: center; justify-content: center" absolute="true">
...
<img src="net.png" alt="" style="object-fit: scale-down">
...
<img src="https://cdn-images-1.medium.com/max/1600/0*mRGKYujQkI7PcMDE." alt="" style="object-fit: scale-down">

source: https://dzone.com/articles/introduction-to-word-vectors
</div></script></section><section  data-markdown><script type="text/template"><!-- .slide: class="drop" -->
<div class="" style="position: absolute; left: 0px; top: 0px; height: 700px; width: 960px; min-height: 700px; display: flex; flex-direction: column; align-items: center; justify-content: center" absolute="true">

<img src="https://cdn-images-1.medium.com/max/1600/0*CldH-gf1GuWjqNjt." alt="" style="object-fit: scale-down">
